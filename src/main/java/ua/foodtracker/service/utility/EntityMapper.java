...
public class EntityMapper {
    ...
    public static UserEntity mapUserToEntityUser(User user) {
        ...
        return UserEntity.builder()
                ...
                .withGender(GenderEntity.valueOf(user.getGender().name()))
                .withHeight(user.getHeight())
                .withLifestyle(LifestyleEntity.valueOf(user.getLifestyle().name()))
    ...
    public static User mapUserEntityToUser(UserEntity userEntity) {
        ...
        return User.builder()
                ...
                .withGender(Gender.valueOf(userEntity.getGenderEntity().name()))
                .withHeight(userEntity.getHeight())
                .withLifestyle(Lifestyle.valueOf(userEntity.getLifestyleEntity().name()))
